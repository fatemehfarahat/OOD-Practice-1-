...
<h2><b>گام پنجم: (نتیجه گیری)</b></h2>

در این برنامه، رعایت اصول شیءگرایی به بهبود قابلیت نگهداری و نظارت کمک می‌کند.
با تغییر در یک بخش از سیستم  نیاز به تغییر در ماژول‌های اصلی و ثابت (مانند رزرویشن سرویس) نیست.
 هر کلاس وظیفه مشخصی دارد و باعث می‌شود درک و عیب‌یابی کد برای توسعه‌دهندگان جدید آسان شود.
اینترفیس‌های کوچک و تفکیک شده  تضمین می‌کنند که لایه‌های مختلف کد فقط به آن چیزی وابسته باشند که نیاز دارند، که باعث می‌شود سیستم انعطاف‌پذیرتر و قابل پیکربندی باشد.
در آخر، رعایت اصول شی گرایی باعث شد برنامه به یک نظم برسد که باعث می‌شود نگهداری برنامه بسیار ساده تر شود. در کل با رعایت این اصول، با تغییرات کمتر میتوانیم قابلیت های زیادی را اضافه کنیم و نگران نباشیم که چندین تغییر نیاز است و تغییرات از قلم بیافتد.
